...
class Func:
    def spider(self, sm):
        time.sleep(2)
        url = 'https://api.huobi.vn/market/history/kline?period=15min&size=20&symbol=' + str(sm)
    ...
    def write_db(self, data):
        try:
            insert_sql = "REPLACE INTO xy_15min_info(pid, timestamp, openingPrice, closingPrice, " \
