...
class Func:
    def spider(self, sm):
        time.sleep(2)
        url = 'https://api.huobi.vn/market/history/kline?period=1day&size=20&symbol=' + str(sm)
    ...
    def write_db(self, data):
        try:
            insert_sql = "REPLACE INTO xy_dayk_info(pid, timestamp, openingPrice, closingPrice, " \
