...
class Func:
    def spider(self, sm):
        time.sleep(5)
        url = 'https://api.huobi.vn/market/history/kline?period=4hour&size=20&symbol=' + str(sm)
    ...
    def write_db(self, data):
        try:
            insert_sql = "REPLACE INTO xy_4hour_info(pid, timestamp, openingPrice, closingPrice, " \
