...
class Func:
    def spider(self, sm):
        time.sleep(20)
        url = 'https://api.huobi.vn/market/history/kline?period=1mon&size=12&symbol=' + str(sm)
    ...
    def write_db(self, data):
        try:
            insert_sql = "REPLACE INTO xy_month_info(pid, timestamp, openingPrice, closingPrice, " \
